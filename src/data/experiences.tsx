export const experiences = [
	...
	{
		title: 'Ruangguru Bootcamp - Kampus Merdeka',
		multiple: false,
		role: 'Frontend Engineering',
		date: 'Jan 2023 - Jul 2023',
		imagePath: '/src/assets/ruangguru-logo.png',
		techStack: ['General Competence', 'Software Engineering', 'Javascript', 'ReacjtJS'],
		desc: [
			"Learning web frontend skills through the MBKM program's Bootcamp Learning Plan, focusing on JavaScript and React.js in both basic and advanced front-end development."
		]
	},
	{
		title: 'Social Circles Co.',
		multiple: false,
